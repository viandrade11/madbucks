      ...
      <section className="relative min-h-screen flex items-center" style={{ paddingTop: "calc(56px + var(--ticker-height, 0px))" }}>
        <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative h-[500px] lg:h-[600px]">
            <img src={heroImg} alt="Produtos Madbucks para cuidado de tatuagem dispostos sobre superficie escura com pele tatuada ao fundo" className="w-full h-full object-cover rounded" width={1920} height={1080} /> alt="Produtos Madbucks para cuidado de tatuagem dispostos sobre superfície escura com pele tatuada ao fundo" className="w-full h-full object-cover rounded" width={1920} height={1080} /> className="w-full h-full object-cover rounded" width={1920} height={1080} />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <ScrollReveal direction="left">
              <img src={tattooImg} alt="Braco tatuado recebendo aplicacao de creme hidratante Madbucks para preservar cores e detalhes" loading="lazy" className="w-full h-[450px] object-cover rounded" width={800} height={1000} /> alt="Braço tatuado recebendo aplicação de creme hidratante Madbucks para preservar cores e detalhes" loading="lazy" className="w-full h-[450px] object-cover rounded" width={800} height={1000} /> loading="lazy" className="w-full h-[450px] object-cover rounded" width={800} height={1000} />
            </ScrollReveal>
      ...
      <section id="como-funciona" className="section-padding bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              <img src={routineImg} alt="Rotina de skincare para tatuagem em 3 passos com produtos Madbucks" loading="lazy" className="w-full h-[450px] object-cover rounded" width={1200} height={800} /> alt="Rotina de skincare para tatuagem em 3 passos: limpeza, hidratação e intensificação com produtos Madbucks" loading="lazy" className="w-full h-[450px] object-cover rounded" width={1200} height={800} /> loading="lazy" className="w-full h-[450px] object-cover rounded" width={1200} height={800} />
            </div>
          </div>
        </div>
      </section>
