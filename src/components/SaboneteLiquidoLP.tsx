...
const SaboneteLiquidoLP = ({ product }: SaboneteLiquidoLPProps) => {
  ...
  return (
    <>
      ...
      <UpsellSection excludeHandle="madbucks-sabonete-liquido-tattoo" />
