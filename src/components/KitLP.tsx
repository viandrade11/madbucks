...
const TICKER_ITEMS = ["ROTINA COMPLETA", "ECONOMIA REAL", "INGREDIENTES NATURAIS", "CRUELTY-FREE", "DERMATOLOGICAMENTE TESTADO", "IDEAL PARA PRESENTEAR"];
const KIT_PRODUCTS = [
