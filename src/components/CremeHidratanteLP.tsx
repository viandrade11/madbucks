...
import {
  ...
  Droplets, Shield, Sparkles, Moon, Clock
} from "lucide-react";
...
const BENEFITS_DETAILED = [
  {
    icon: Clock,
    title: "Hidratação de 24 Horas",
    desc: "Fórmula de longa duração com ácido hialurônico que mantém a pele tatuada hidratada o dia todo. Uma única aplicação, proteção prolongada.",
  },
  {
    icon: Shield,
    title: "Sem Ingredientes Agressivos",
    desc: "Zero álcool, zero parabenos, zero fragrâncias sintéticas. Cada ingrediente foi escolhido para não degradar os pigmentos da sua tatuagem.",
  },
  {
    icon: Sparkles,
    title: "Toque Seco e Leve",
    desc: "Absorção rápida que não deixa sensação oleosa ou pegajosa. Use sob roupas sem preocupação.",
  },
  {
    icon: Moon,
    title: "Rotina Dia e Noite",
    desc: "Formulado para uso contínuo, manhã e noite. A base perfeita da sua rotina de cuidado com a tattoo.",
  },
];
...
const INGREDIENTS = [
  {
    ...
    benefits: ["Hidratação profunda nas camadas da pele", "Retém até 1000x seu peso em água", "Melhora a elasticidade da pele"],
  },
  {
    name: "Ceramidas",
    benefits: ["Restaura a barreira cutânea", "Previne perda de umidade", "Fortalece a camada protetora da pele"],
  },
  {
    name: "Aloe Vera",
    benefits: ["Propriedades calmantes e anti-inflamatórias", "Auxilia na regeneração celular", "Refresca e suaviza a pele"],
  },
  {
    name: "Vitamina B5",
    benefits: ["Acelera a recuperação da pele", "Melhora a retenção de umidade"],
  },
];

const HOW_TO_STEPS = [
  { num: "01", title: "Limpe a pele", desc: "Após o banho, seque a pele tatuada suavemente com uma toalha macia. A pele limpa absorve melhor o creme." },
  { num: "02", title: "Aplique generosamente", desc: "Retire uma quantidade generosa e aplique sobre toda a área tatuada. Cubra bem a tatuagem inteira." },
  { num: "03", title: "Massageie até absorção", desc: "Massageie em movimentos circulares suaves até a completa absorção. Use manhã e noite para resultados ideais." },
];

const FAQS = [
  { q: "O Creme Hidratante é a base da rotina?", a: "Sim. O Creme Hidratante Tattoo é o produto fundamental da rotina Madbucks. Ele entrega a hidratação profunda e prolongada que a pele tatuada precisa diariamente." },
  { q: "Posso usar em pele sensível?", a: "Sim. O creme é hipoalergênico e dermatologicamente testado, seguro para todos os tipos de pele, incluindo peles sensíveis." },
  ...
  { q: "É indicado para pós-tattoo?", a: "Sim. Pode ser utilizado após o período inicial de cicatrização. Consulte seu tatuador sobre o momento ideal para começar." },
  { q: "Deixa a pele oleosa?", a: "Não. A fórmula tem toque seco e absorção rápida. Você pode se vestir imediatamente após a aplicação sem sensação pegajosa." },
  { q: "Com que frequência devo usar?", a: "Recomendamos uso duas vezes ao dia: manhã e noite. A consistência é a chave para resultados duradouros." },
  { q: "Posso usar junto com o Intensify?", a: "Sim! A sequência ideal é: Sabonete → Creme Hidratante → Intensify. O creme prepara a pele para absorver melhor o Intensify." },
  { q: "Quanto tempo dura um pote?", a: "Com uso diário (manhã e noite) em áreas tatuadas de tamanho médio, cada pote dura em média 45-60 dias." },
];

interface CremeHidratanteLPProps {
    ...
    <>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Hidratação profunda de 24 horas que sua pele tatuada precisa todos os dias. Fórmula com ácido hialurônico e ceramidas, sem álcool e sem fragrâncias sintéticas.
                </p>
              </div>
              <div className="flex flex-wrap gap-x-6 gap-y-2">
                {[
                  { icon: Clock, text: "Hidratação 24h" },
                  { icon: Droplets, text: "Toque seco" },
                  { icon: Shield, text: "Sem álcool" },
                ].map((badge, i) => (
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <p className="text-xs font-bold uppercase tracking-[0.3em] text-muted-foreground mb-3">Resultados</p>
            <h2 className="font-display text-2xl md:text-3xl tracking-tight text-foreground">A Base da Sua Rotina</h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              <div>
                ...
                <h2 className="font-display text-2xl md:text-3xl tracking-tight text-foreground">Hidratação Que Sua Tattoo Precisa</h2>
              </div>
            ...
            <div className="aspect-[4/5] overflow-hidden rounded bg-muted flex items-center justify-center">
              {images[1]?.node ? (
                <img src={images[1].node.url} alt="Creme Hidratante Madbucks" className="w-full h-full object-cover" loading="lazy" />
              ) : images[0]?.node ? (
                <img src={images[0].node.url} alt="Creme Hidratante Madbucks" className="w-full h-full object-cover" loading="lazy" />
              ) : (
      ...
      <section className="bg-foreground text-background py-5">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {["HIDRATAÇÃO 24H", "SEM ÁLCOOL", "TOQUE SECO", "HIPOALERGÊNICO"].map((item, i) => (
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-muted-foreground max-w-xl mx-auto">Ingredientes dermatologicamente selecionados para hidratar profundamente sem degradar os pigmentos da tatuagem.</p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="order-2 lg:order-1 aspect-[4/5] overflow-hidden rounded bg-muted flex items-center justify-center">
              {images[2]?.node ? (
                <img src={images[2].node.url} alt="Como usar o Creme Hidratante" className="w-full h-full object-cover" loading="lazy" />
              ) : images[0]?.node ? (
                <img src={images[0].node.url} alt="Como usar o Creme Hidratante" className="w-full h-full object-cover" loading="lazy" />
              ) : (
                <span className="text-muted-foreground text-sm">Sem imagem</span>
              )}
            </div>
            <div className="order-1 lg:order-2 space-y-8">
              <div>
                ...
                <h2 className="font-display text-2xl md:text-3xl tracking-tight text-foreground">Limpe, Aplique, Massageie.</h2>
                <p className="text-sm text-muted-foreground mt-3">A base da rotina Madbucks. Use manhã e noite para melhores resultados.</p>
              </div>
              <div className="space-y-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              { handle: "madbucks-tattoo-balm-stick-69668baa49da0", title: "Balm Stick", step: "Passo 2 — Proteja", desc: "Proteção portátil durante o dia" },
      ...
      <section className="py-20 bg-foreground text-background">
        <div className="container mx-auto px-4 text-center space-y-6">
          <h2 className="font-display text-2xl md:text-3xl tracking-tight">Hidratação Profunda. Todos os Dias.</h2>
          <p className="text-sm opacity-60 max-w-md mx-auto">A base da sua rotina de cuidado. Sem álcool, sem fragrâncias, sem compromisso.</p>
