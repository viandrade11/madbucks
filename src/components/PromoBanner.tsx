...
const PROMOS = [
  {
    ...
    desc: "Na compra de 2 produtos, leve o Sabonete Líquido Tattoo de presente. Use o cupom no checkout.",
    code: "GANHE-SABONETE",
    cta: "Ver Produtos",
    href: "/collections",
  },
  {
    ...
    desc: "Levando o Tattoo Balm, ganhe 15% de desconto no Creme Hidratante. A dupla perfeita para sua rotina.",
    code: "COMBO15",
    cta: "Montar Combo",
    href: "/collections",
  },
