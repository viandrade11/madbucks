          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <ScrollReveal direction="right">
              <div className="aspect-[4/5] overflow-hidden rounded bg-muted flex items-center justify-center">
                {images[1]?.node ? <img src={images[1].node.url} alt="Balm Stick Madbucks em uso na pele tatuada" className="w-full h-full object-cover" loading="lazy" /> : images[0]?.node ? <img src={images[0].node.url} alt="Balm Stick Madbucks hidratante compacto para tatuagens" className="w-full h-full object-cover" loading="lazy" /> : <span className="text-muted-foreground text-sm">Sem imagem</span>} ? <img src={images[1].node.url} alt="Balm Stick Madbucks em uso — aplicação prática e rápida em tatuagem" className="w-full h-full object-cover" loading="lazy" /> : images[0]?.node ? <img src={images[0].node.url} alt="Balm Stick Madbucks — bastão hidratante compacto para tatuagens" className="w-full h-full object-cover" loading="lazy" /> : <span className="text-muted-foreground text-sm">Sem imagem</span>} className="w-full h-full object-cover" loading="lazy" /> : <span className="text-muted-foreground text-sm">Sem imagem</span>}
              </div>
            </ScrollReveal>
          </div>
        </div>
      ...
      <section className="section-padding bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <ScrollReveal direction="left">
              <div className="aspect-[4/5] overflow-hidden rounded bg-muted flex items-center justify-center">
                {images[2]?.node ? <img src={images[2].node.url} alt="Como usar o Balm Stick Madbucks na pele tatuada" className="w-full h-full object-cover" loading="lazy" /> : images[0]?.node ? <img src={images[0].node.url} alt="Modo de uso do Balm Stick Madbucks" className="w-full h-full object-cover" loading="lazy" /> : <span className="text-muted-foreground text-sm">Sem imagem</span>} ? <img src={images[2].node.url} alt="Passo a passo de como usar o Balm Stick Madbucks na pele tatuada" className="w-full h-full object-cover" loading="lazy" /> : images[0]?.node ? <img src={images[0].node.url} alt="Modo de uso do Balm Stick Madbucks" className="w-full h-full object-cover" loading="lazy" /> : <span className="text-muted-foreground text-sm">Sem imagem</span>} className="w-full h-full object-cover" loading="lazy" /> : <span className="text-muted-foreground text-sm">Sem imagem</span>}
              </div>
            </ScrollReveal>
            <div className="space-y-8">
